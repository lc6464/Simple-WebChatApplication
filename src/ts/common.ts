...
): Promise<{ success: boolean; result: Response | { success: boolean; code: number; message?: string; data?: string; displayName?: string }; message?: string }>;
export async function fetchText(
	input: URL | string,
	initOrAsJson?: boolean,
): Promise<{ success: boolean; result: Response | { success: boolean; code: number; message?: string; data?: string; displayName?: string }; message: string | null }>;
export async function fetchText(
	input: URL | string,
	initOrAsJson?: RequestInit,
	asJson?: boolean,
