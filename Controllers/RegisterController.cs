...
public class RegisterController : ControllerBase {
	...
	public RegisterGetResponse Get([FromForm(Name = "access-token")] string? accessToken, [FromForm(Name = "register-data")] string? registerData) {
	...
	[HttpPost]
	[ResponseCache(CacheProfileName = "NoStore")]
	public RegisterUserPostResponse UserPost([FromForm] string? account, [FromForm] string? password, [FromForm(Name = "repeat-password")] string? repeatPassword) {
		if (_tools.IsLogin()) {
